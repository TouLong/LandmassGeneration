...
{
    public static MeshData GenerateTerrainMesh(float[,] heightMap, float heightMultiplier, AnimationCurve curve, int lod)
    {
...
public class MeshData
{
    ...
    Vector3[] CalculateNormals()
    {
        ...
        {
            int normalTriangleIndex = i * 3;
            int a = borderTriangles[normalTriangleIndex];
            int b = borderTriangles[normalTriangleIndex + 1];
            int c = borderTriangles[normalTriangleIndex + 2];
